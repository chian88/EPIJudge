...
public class TreeConnectLeaves {
	...
	static void createListOfLeavesHelper(BinaryTreeNode<Integer> tree,
										 List<BinaryTreeNode<Integer>> res) {
		if (tree == null) return;
		createListOfLeavesHelper(tree.left, res);
		if (tree.left == null && tree.right == null) res.add(tree);
		createListOfLeavesHelper(tree.right, res);
	}
