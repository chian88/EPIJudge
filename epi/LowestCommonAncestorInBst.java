...
public class LowestCommonAncestorInBst {
	...
	public static BstNode<Integer>
	findLcaHelper(BstNode<Integer> tree, BstNode<Integer> s, BstNode<Integer> b) {
		// TODO - you fill in here.
		if (tree == null) return null;
		if (tree.data == s.data) return tree;
		if (tree.data == b.data) return tree;

		if (s.data < tree.data && b.data < tree.data) {
			BstNode<Integer> leftRes = findLcaHelper(tree.left, s ,b);
			if (leftRes != null) return leftRes;
		} else if (s.data > tree.data && b.data > tree.data) {
			BstNode<Integer> rightRes = findLcaHelper(tree.right, s, b);
