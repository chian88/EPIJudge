...
public class PivotList {
	...
	public static void main(String[] args) {
		...
		ListNode<Integer> eleven = new ListNode<>(11, null);
		ListNode<Integer> five = new ListNode<>(5, eleven);
		ListNode<Integer> seven = new ListNode<>(7, five);
		ListNode<Integer> eleven2 = new ListNode<>(11, seven);
		ListNode<Integer> two = new ListNode<>(2, eleven2);
		ListNode<Integer> two2 = new ListNode<>(2, two);
		ListNode<Integer> three = new ListNode<>(3, two2);
		listPivoting(three, 7);
